...
const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$h);
const __iconNode$g = [
...
const LifeBuoy = createLucideIcon("life-buoy", __iconNode$8);
const __iconNode$7 = [
  [
    "path",
    {
...
const Repeat2 = createLucideIcon("repeat-2", __iconNode$5);
const __iconNode$4 = [
